...
<!--HTML PICTURE BACKGROUND WORK IN PROGRESS-->
 ...
 -->
	...
	<section id="right">
		<div id="totalPicked">
			...
			<h2><span class="red">22,154 lbs!</span></h2>
	...
	<div id="wardImg">
		<img src="images/pics/wards.jpg" height="500" width="300">
	</div>
	</div>
	...
	<section id="getInvolved">
		<div id="mailing">
			...
			<p id="firstline">A cheque addressed to “Tides Canada Initiatives Society – Not Far From The Tree” and mail it to:</p>
			...
			<p>Your donation will be put to work immediately by stewarding Toronto’s urban orchard, building community, and making use of an existing 
	...
	<section class="formgroup">
    	...
    	<form parsley-validate>
	  		...
	  		<div class="formgroup">
	  			...
	  			<input type="radio" name="yesno" value="yes">Yes</input>
				<input type="radio" name="yesno" value="no">No</input>
     ...
     <div id="post1">
       ...
       <p id="author">Author: Mike Harrington Posted: November 2nd, 2013</p>
       <p id="post">Whether you’re celebrating your birthday or a bachelorette party, throwing axes will bring the festivities to a boastfully badass level. We won’t be heaving any hatchets at this Friday’s End of Season Celebration – but we will be raffling off the chance for you and a group of friends to test your mettle with the Backyard Axe Throwing League (B.A.T.L.)...</p>
     ...
     <div id="post2">
       ...
       <img src="http://placehold.it/150x150">
       <p id="author">Author: Mike Harrington Posted: November 2nd, 2013</p>
       <p id="post">Recently I found myself with a small mountain of crab apples from a late season pick. I’ve always been a fan of these underdog edibles. Sure crab apples don’t make a great first impression when sampled raw or pelted at you...</p>
       <input type="submit" value="Read more" class="btn">
     </div>
